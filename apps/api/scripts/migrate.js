...
async function main() {
  ...
  try {
    ...
    for (const filename of migrations) {
      ...
      if (['025_total_card_reference.sql', '027_complete_total_card_reference.sql', '030_replace_card_reference_41.sql', '082_materialize_total_transaction_cards.sql', '083_reconcile_tcm_total_cards.sql'].includes(filename)) {
