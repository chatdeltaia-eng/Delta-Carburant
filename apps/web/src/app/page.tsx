    ...
    <section className={styles.settings}>
      {direction&&<article className={styles.totalConnector}>
        ...
        <details className={styles.connectorConfig}><summary>Mode de secours administrateur</summary><form onSubmit={connect} className={styles.connectorForm}>
          ...
          <label>Synchronisation automatique<select name="syncIntervalMinutes" defaultValue={total.syncIntervalMinutes??1}><option value="1">Temps réel · chaque minute</option><option value="15">Toutes les 15 minutes</option><option value="30">Toutes les 30 minutes</option><option value="60">Toutes les heures</option><option value="120">Toutes les 2 heures</option></select></label>
